...
- [**Каждый уважающий себя разработчик должен знать:**](#Каждый-уважающий-себя-разработчик-должен-знать-)
    - [ ] [Книги](#Книги-)
    - [x] [Английский язык](#Английский-язык-)
...
- [ ] Статьи:
    ...
    - [ ] [Важнейшие структуры данных](https://habr.com/ru/company/alconost/blog/419685/)
...
- [ ] Виды тестов:
    - [ ] Блочное тестирование (модульное, unit testing)
        - [ ] [Неприятные ошибки при написании юнит тестов](https://habr.com/ru/post/432092/)
        - [ ] [7 правил хорошего тона при написании Unit-тестов](https://habr.com/ru/company/wrike/blog/337188/)
        - [ ] [Юнит-тестирование в PHP](https://habr.com/ru/post/56289/)
        - [ ] [PHP Unit. Опыт тестирования классов, работающих с Базой Данных](https://habr.com/ru/post/139727/)
        - [ ] [Что-то не то с тестированием в .NET (Java и т.д.)](https://habr.com/ru/post/318642/)
        - [ ] [Тестирование с базой данных в .NET](https://habr.com/ru/post/319568/)
        - [ ] [Моки и стабы](https://habr.com/ru/post/134836/)
        - [ ] [Microsoft Moles](https://habr.com/ru/post/109891/)
